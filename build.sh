...
[[ "$@" == "clean" ]] && rm -rf user lpm
[[ ! -f lpm ]] && curl https://github.com/lite-xl/lite-xl-plugin-manager/releases/download/latest/lpm.x86_64-linux > lpm || { echo "Can't download lpm." && exit -1 }
